  ...
  return (
    <Link
      ...
      className="
        ...
        border border-[#F1F5F9] dark:border-[#2E3D5F]
        shadow-[0_2px_8px_rgba(0,0,0,0.05)] dark:shadow-[0_2px_8px_rgba(0,0,0,0.3)]
        text-inherit no-underline
        transition-all duration-250
        hover:-translate-y-1
        hover:shadow-[0_16px_36px_rgba(0,0,0,0.12)]
        dark:hover:shadow-[0_16px_36px_rgba(0,0,0,0.5)]
      "
    >
      {/* Image */}
      <div className="overflow-hidden" style={{ height: "clamp(160px, 14vw, 220px)" }}>
      ...
      <div className="p-[clamp(14px,1.5vw,20px)]">
        ...
        <span
          ...
          style={{ color: blog.categoryColor ?? "#2563EB" }}
        >
          {blog.category}
        </span>
        ...
        {/* Title */}
        <h3
          className="font-poppins font-semibold text-[#0F172A] dark:text-[#F1F5F9] leading-snug my-2"
        ...
        {/* Excerpt */}
        <p
          className="text-[#475569] dark:text-[#CBD5E1] leading-relaxed mb-3 line-clamp-2"
          style={{ fontSize: "clamp(12px, 0.88vw, 14px)" }}
        >
          {blog.excerpt}
        </p>
