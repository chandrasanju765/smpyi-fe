    ...
    <section className="px-4 sm:px-6 lg:px-8 py-12 bg-[var(--bg-surface)]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <p className="font-poppins" style={{ fontWeight: 500, fontSize: 20, lineHeight: "120%", color: "var(--category-accent)" }}>
            Explore Our categories
          </p>
          <h2 className="font-poppins mt-2" style={{ fontWeight: 500, fontSize: 36, lineHeight: "150%", color: "var(--category-heading)" }}>
            Find what you&apos;re looking for
          </h2>
          <p className="font-poppins mt-3 mx-auto" style={{ fontWeight: 400, fontSize: 16, lineHeight: "150%", color: "var(--category-desc)", textAlign: "center", maxWidth: "495px" }}>
            Explore our extensive range of product and service categories tailored for every business need.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {CATEGORIES.map((cat) => (
            <CategoryCard
              ...
              icon={
                // Wrap in sized div so Image has layout context
                <div style={{ position: "relative", width: "48px", height: "48px" }}>
                  <Image src={cat.iconSrc} alt={cat.name} fill sizes="48px" className="object-contain" />
                </div>
              }
            />
          ))}
